...
class Item extends Component{
    ...
    render(){
      ...
      return(
        ...
        <div style={{...styles.box,padding:  "0.45rem 1rem", borderColor: "#616161"}} className={"movieBox Me" + (!this.state.favId?" hideMe": "")}>
          ...
          <button onClick={_=>this.setFav(props.movieId)} className="button is-light is-small favs" style={styles.favs} title="Remove this item to your favs list">
        ...
        <img src={props.cover} alt="" style={{display: "block",minWidth: "170px", margin: "0 auto", ...styles.fadeIn}}/>
        <button onClick={_=>this.setFav(props.movieId)} className="button is-dark is-small favs" style={styles.favs} title="Add item to your favs list">
          <i className={"fas fa-heart " + (this.state.favId ? "has-text-danger":"has-text-white")}></i>
        </button>
        </div>
